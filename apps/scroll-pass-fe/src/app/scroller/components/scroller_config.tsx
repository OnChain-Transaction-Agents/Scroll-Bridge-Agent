  ...
  return (
    <div className="flex flex-col gap-4 font-medium text-sm">
      ...
      <div className="flex items-center">
        <p>Simply mint and deposit, and your Scroll Pass will make sure that you always save on gas when bridging to Scroll!</p>
      </div>
      ...
      <div className="text-base flex flex-col gap-4 pt-2">
        ...
        <div className="text-xs flex justify-between pb-3 opacity-60 leading-[0]">
          <p>This does not include the gas fee to mint your Scroll Pass NFT</p>
            ...
            <div>
              {trendingDownward ? (
                <div>
                  <div className="flex">
                    <div>
                      Scroll Pass predicts gas is trending{' '}
                      {isLoading ? (
                        <Spinner
                          color="white"
                          size="sm"
      ...
      <div className="text-xs">
        ...
        <p className="pt-3 opacity-60">Leave blank to mint Scroll Pass but deposit funds later.</p>
      </div>
