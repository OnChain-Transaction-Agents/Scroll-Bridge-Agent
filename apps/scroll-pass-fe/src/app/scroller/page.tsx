            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16">
              ...
              <div className="flex flex-col grow-0">
                ...
                <div className="mt-8 font-medium text-sm">
                  <p className="mb-2">
                    Scroll Pass is an experimental NFT app that lets you bridge ETH from mainnet to Scroll L2 when gas fees are low. We are
                    currently in close beta, and only allowlisted addresses can mint. Join the Scroll Pass waitlist now and be first in line
                  ...
                  <p>
                    ...
                    &nbsp;to be among the first to hear about the public release of Scroll Pass!
                  </p>
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16">
              ...
              <div className="md:w-1/2">
                ...
                <div className="mb-4 text-[#a6a9ae]">
                  <p className="mb-2">
                    Scroll Pass Bot is a game-changing Smart NFT that monitors gas fees, and bridges your ETH to the Scroll blockchain at
                    the most opportune moment .{' '}
                  </p>
                  <p className="mb-2">
                    No fuss, just mint your Scroll Pass, set your gas tolerance and top up its balance whenever you want to bridge ETH to
                    the Scroll L2.
                  </p>
                  <p className="mb-2">
                    Forget waking up at 4am to catch the lowest gas prices. Step into the future and maximize your wallet&apos;s potential
                    with your own Scroll Pass!
                  </p>
                </div>
                <a
                ...
                >
                  ...
                  <span className="font-medium">Set up your Scroll Pass</span>
                ...
                >
                  ...
                  <span className="font-medium">View minted Scroll Pass</span>
                  <span className="h-3 w-3">
                    <ChevronRight />
                  </span>
                </a>
